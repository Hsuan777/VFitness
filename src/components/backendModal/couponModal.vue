<template>
  <div class="modal fade" ref="couponModal" data-bs-backdrop="static"
            ...
            <div class="row g-3">
              ...
              <div class="col">
                ...
                <Field id="couponPercent" name="折扣率" type="number" class="form-control"
                  ...
                  rules="min_value:0|max_value:99|required" v-model.number="tempCoupon.percent">
                </Field>
...
export default {
  ...
  methods: {
    addCoupon() {
      ...
      this.axios.post(apiUrl, couponObj).then((res) => {
        if (res.data.success) {
          this.hideModal();
          this.$emit('update');
