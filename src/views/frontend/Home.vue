      ...
      <ul class="studio__goal list-unstyled">
        ...
        <li class="row flex-row-reverse align-items-center mb-5">
          ...
          <div class="col-md-6 col-lg-7">
            <img
              src="https://images.unsplash.com/photo-1564464392342-54692a5d59a0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1920&q=80"
              alt="減脂餐(豬肉)"
              class="w-100 rounded"
            />
          </div>
        ...
        <li class="row align-items-center mb-5">
          ...
          <div class="col-md-6 col-lg-7">
            <img
              src="https://images.unsplash.com/flagged/photo-1566064336477-864e4f308992?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80"
              alt="一對一訓練"
              class="w-100 rounded"
            />
          </div>
        ...
        <li class="row flex-row-reverse align-items-center mb-5">
          ...
          <div class="col-md-6 col-lg-7">
            <img
              src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80"
              alt="團課訓練"
              class="w-100 rounded"
            />
          </div>
      ...
      team: [
        {
          name: 'Vic',
          imageUrl:
            'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=334&q=80',
          job: '創立人。教練',
        },
        {
          name: 'Jaron',
      ...
      experience: [
        {
          name: 'Andy',
          imageUrl:
            'https://images.unsplash.com/photo-1601455763557-db1bea8a9a5a?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=786&q=80',
          description:
        ...
        },
        {
          name: 'Vivian',
          imageUrl:
            'https://images.unsplash.com/photo-1545912453-db258ca9b7b7?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=668&q=80',
          description:
        ...
        },
        {
          name: 'Abbie',
          imageUrl:
            'https://images.unsplash.com/photo-1514626585111-9aa86183ac98?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1920&q=80',
          description:
        ...
        },
        {
          name: 'John',
          imageUrl:
            'https://images.unsplash.com/photo-1520409364224-63400afe26e5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=358&q=80',
          description:
